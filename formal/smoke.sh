...
CORE="formal/alloy/core/causlane_core.als"
NEG="formal/alloy/checks/unconstrained_counterexample.als"
RECEIPT="formal/receipts/alloy-core.json"
...
GEN_SUCCESS="formal/alloy/generated/release_promote_success.als"
GEN_NEG_EXEC="formal/alloy/generated/execution_without_barrier_invalid.als"
GEN_NEG_LEASE="formal/alloy/generated/conflicting_leases_invalid.als"
GEN_RECEIPT="formal/receipts/release_promote.codegen.json"
...
mkdir -p "$CLASSES" formal/receipts formal/alloy/generated target/formal
if [ ! -f "$CLASSES/AlloyRunner.class" ] || [ formal/tools/AlloyRunner.java -nt "$CLASSES/AlloyRunner.class" ]; then
  javac -cp "$ALLOY_JAR" -d "$CLASSES" formal/tools/AlloyRunner.java
fi
