...
pub use protocol::{
    ...
    GraphIndex, GraphNode, HostDispatchContext, HostDispatchContextBuilder, HostDispatchError,
    HostDispatchTicket, HostDispatcherCapabilities, HostDrainOutcome, HostEffectClass,
    HostEffectOutcome, HostRuntimeProfile, HostTaskSpec, HostTaskSpecBuilder, ImpactHardness,
    ImpactSetHash, Lane, LaneAdmission, LaneCapacity, LaneId, LaneRejection, Lease, LeaseId,
    LeaseRef, LeaseTable, LeaseTableError, LifecycleClass, LifecycleStage, LifecycleViolation,
    NotParallelReason, ObligationSet, Op, OpId, PairConflict, PartitionKey, PartitionRoute,
    PlanHash, PlanHashError, PredicateId, ProjectionReadRequest, RedactionClass,
    ...
    ALL_AUDIT_EVENT_KINDS, CAUSLANE_HOST_API_VERSION, MAY_PROJECT_STAGE,
};
